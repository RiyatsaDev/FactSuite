...
<section id="pg-cntr">
  <div class="pg-hdr">
     ...
     <div id="FS-candidate-mn">
        <ul class="nav nav-tabs nav-justified">
           ...
           <li class="nav-item">
              <a class="nav-link active" href="all-cases.html">All Cases</a>
           </li>
           <li class="nav-item">
  ...
  <div class="pg-cnt">
    ...
    <tbody>
        <tr data-toggle="collapse" data-target="#cases1" class="accordion-toggle">
            <td>1029</td>
            <td>Sreenivas</td>
            <td>sreenivasreddy37@gmail.com</td>
            <td>+91 7829391577</td>
            <td>Riyatsa</td>
            <td class="completed"><i class="fa fa-check"></i>Completed</td>
        </tr>
        <tr>
            <td colspan="6" class="hiddenRow">
               <div class="accordian-body collapse" id="cases1"> 
                  <div class="cases-bx-txt">
                     <ul>
                        <li class="active"></li>
                        <li class="active"></li>
                        <li class="active"></li>
        ...
        <tr data-toggle="collapse" data-target="#cases2" class="accordion-toggle">
            <td>1029</td>
        ...
        <tr data-toggle="collapse" data-target="#cases3" class="accordion-toggle">
            <td>1029</td>
            <td>Ashish Kandemebth</td>
            <td>ashishkkadooe@gmail.com</td>
            <td>+91 8086845236</td>
